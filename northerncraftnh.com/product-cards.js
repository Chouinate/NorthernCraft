...
(function () {
  ...
  var CSS = [
    ...
    '  min-width:180px;',
    '}',
    '#bb-img-wrap{width:50px;height:50px;flex-shrink:0;overflow:hidden;background:var(--panel)}',
    '#bb-img-wrap img{width:100%;height:100%;object-fit:cover;display:block}',
    '#bb-pname{font-family:var(--ff-serif);font-size:17px;font-weight:400;',
    '  color:var(--charcoal);margin:0 0 2px;line-height:1.1}',
    '#bb-pspecs{font-family:var(--ff-sans);font-size:9px;letter-spacing:.09em;',
    ...
    '}',
    '#bb-tiers{display:flex;align-items:center;gap:4px;flex-wrap:wrap;justify-content:center}',

    /* tier label — display only, not interactive */
    '.bb-tier{',
    '  padding:5px 11px;',
    '  border:1.5px solid rgba(92,53,69,.16);',
    '  font-family:var(--ff-sans);font-size:9px;letter-spacing:.15em;',
    ...
    '  flex-shrink:0;border-left:1px solid rgba(92,53,69,.08);',
    '  min-width:175px;',
    '}',
    '#bb-back{',
